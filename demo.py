"""
demo.py
Run this after installing requirements and downloading spaCy model.
It will print the analysis JSON for the sample transcript.
"""
from nlp_pipeline import analyze_transcript

sample_transcript = """Doctor: Good morning, Ms. Jones. How are you feeling today?
